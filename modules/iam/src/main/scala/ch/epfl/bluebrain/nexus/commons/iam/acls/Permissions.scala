...
/**
  ...
  *
  * @param set the set of [[ch.epfl.bluebrain.nexus.commons.iam.acls.Permission]]s
  */
...
object Permissions {
  ...
  /**
    * Convenience factory method to construct a [[ch.epfl.bluebrain.nexus.commons.iam.acls.Permissions]] instance from var args.
    *
