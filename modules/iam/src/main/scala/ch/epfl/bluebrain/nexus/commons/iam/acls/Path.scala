...
object Path {
  ...
  /**
    ...
    *
    * @param string the source string to convert to a [[ch.epfl.bluebrain.nexus.commons.iam.acls.Path]]
    * @return a new [[ch.epfl.bluebrain.nexus.commons.iam.acls.Path]] instance built from the argument ''string''
    */
