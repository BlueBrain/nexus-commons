package ch.epfl.bluebrain.nexus.service.commons.directives
...
trait ErrorDirectives {
  ...
  /**
    ...
    * implicitly available [[ch.epfl.bluebrain.nexus.service.commons.directives.StatusFrom]] and [[io.circe.Encoder]]
    * instances.
    *
