...
/**
  ...
  *
  * @param set the set of [[ch.epfl.bluebrain.nexus.commons.iam.types.acls.Permission]]s
  */
...
object Permissions {
  ...
  /**
    * Convenience factory method to construct a [[ch.epfl.bluebrain.nexus.commons.iam.types.acls.Permissions]] instance from var args.
    *
